...
export function buildPlan() {
  ...
  return {
    ...
    _typesOnlyEscapeRoute: [
      ...
      "abPairs, which manifest-config.json does not yet declare. It is noise only if each of",
      "the seven appears in both arms of its pair. Decide that when the pairs are written.",
      "",
